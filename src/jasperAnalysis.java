...
public class jasperAnalysis {
            SimpleDateFormat dFormat = new SimpleDateFormat("dd-MM-yyyy");
            Date dat = new Date();
            String date = dFormat.format(dat);
    public jasperAnalysis(int Fid,Connection con) throws FileNotFoundException{
    HashMap<String, Object> parameters = new HashMap<>();
        parameters.put("chid", Fid);
        
        try {
            JasperDesign jasperReport = JRXmlLoader.load(getClass().getResourceAsStream("analysis.jrxml"));
            ...
            FileOutputStream fileOutputStream =new FileOutputStream(new File(System.getProperty("user.home")+File.separator+"Analysis_patientname_"+date+"_N°55555.pdf"));
